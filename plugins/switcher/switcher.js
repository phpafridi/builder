...
{
	var urlLTR = 'https://constructzilla.vercel.app/';
	var urlRTL = 'https://constructzilla-rtl.vercel.app/';
	if(currentURL.indexOf('https://constructzilla-rtl.vercel.app/') > -1){
		urlLTR = currentURL.replace('https://constructzilla-rtl.vercel.app/', 'https://constructzilla.vercel.app/');
		urlRTL = currentURL;
	}else{
		urlRTL = currentURL.replace('https://constructzilla.vercel.app/', 'https://constructzilla-rtl.vercel.app/');
		urlLTR = currentURL;
	}
